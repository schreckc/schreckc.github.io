...
\textbf{\textit{Le code devra être commenté clairement.}}
...
\item Autour de chacuns des ces pentagons, créer un cercle \texttt{m} nouveaux pentagones plus petits, de facon \`a ce qu'ils soient entrelacés avec les premiers (voir Figure \ref{pentagons}) et les faire tourner autour.
\end{enumerate}
